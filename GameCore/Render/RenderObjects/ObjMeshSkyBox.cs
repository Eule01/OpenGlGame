...
namespace GameCore.Render.RenderObjects
{
    public class ObjMeshSkyBox : ObjMesh
    {
        ...
        {
            ObjObject tempObj =
                new ObjObject(ObjectPrimitives.CreateSquareWithNormalsYorZ(new Vector3(0.5, 0.5, -0.5), new Vector3(-0.5, 0.5, 0.5),
                                                            true)); // TOP ?
            ...
            tempObj =
                new ObjObject(ObjectPrimitives.CreateSquareWithNormalX(new Vector3(-0.5,-0.5, 0.5), new Vector3(-0.5, 0.5, -0.5),
                                                            true)); // Left 
            tempMat =
                GameCore.TheGameCore.TheRendererManager.TheRenderer.TheMaterialManager.GetFromFile(program,
        ...
        public ObjMeshSkyBox(string filename, ShaderProgram program) : base(filename, program)
        {
        }
